			...
			<div class="recent-posts" id="blog">
				...
				<div class="recent-posts-head">
					<h3><?php echo __('Watch love die') ?></h3>
					<p><iframe id="yt-video" width="640" height="390" src="https://www.youtube.com/embed/<?php echo $video['Video']['slug']?>" frameborder="0" allowfullscreen></iframe></p>
					<p><?php echo __('This is %s\'s video. %s paid good money to watch us execute love.',$video['User']['name'],$video['User']['name']) ?><br />
